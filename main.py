...
def build_wake_prompt(brain: Brain) -> str:
    ...
    if is_first or hb_num % 10 == 1:
        ...
        parts.append("- `browse`: **Visual browsing** — I can SEE pages like a human!\n")
        ...
        parts.append("  - `action='type', text='...', submit=True`: Type and press Enter\n")
                    ...
                    if result.get("metadata", {}).get("has_image"):
                        ...
                        if image_data:
                            ...
                            if elements:
                                ...
                                for el in elements[:15]:  # 只顯示前 15 個
                            ...
                            conversation.append({
                                ...
                                "parts": [
                                    ...
                                    {
                                        "text": f"[I am now SEEING this webpage. The screenshot shows yellow numbered labels [0], [1], [2]... on clickable elements. I use these label numbers to click.]{elements_hint}"
                                    }
                                ]
                            })
